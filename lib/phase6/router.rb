module Phase6
  class Route
    ...
    def matches?(req)
        return false unless req.request_method == @http_method
    ...
    def run(req, res)
        ...
        params = match_data.names.include?("id") ? {"id"=>match_data[:id] } : {}
  ...
  class Router
    ...
    def add_route(pattern, method, controller_class, action_name)
        @routes << Phase6::Route.new(pattern, method, controller_class, action_name)
    end
